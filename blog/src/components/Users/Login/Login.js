...
const formSchema = Yup.object({
  ten_tai_khoan: Yup.string().required("Username is required"),
  mat_khau: Yup.string().required("Password is required"),
});
                ...
                <div className="px-6 lg:px-12 py-12 lg:py-24 bg-white shadow-lg rounded-lg">
                  ...
                  <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="flex items-center pl-6 mb-3 border border-gray-50 bg-white rounded-full">
                      ...
                      {/* Username */}
                      <input
                        value={formik.values.ten_tai_khoan}
                        onChange={formik.handleChange("ten_tai_khoan")}
                        onBlur={formik.handleBlur("ten_tai_khoan")}
                    ...
                    <div className="text-red-400 mb-2">
                      {formik.touched.ten_tai_khoan && formik.errors.ten_tai_khoan}
                    </div>
